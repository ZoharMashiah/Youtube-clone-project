...
export default function VideoShow({ icon, user, title, description, publication_date, video, views, user_image, onClick }) {
  ...
  return (
      <div className={styles.videoCard}>
        <Image src={icon} width="330vw" height="170vh" id={styles.videoImage} onClick={onClick}/>
          <div className={styles.imageWrapper}>
              <Image src={user_image} width="40px" height="40px" roundedCircle />
            <div className={styles.titleWrapper}>
            <p id={styles.title} onClick={onClick}>{title}</p>
