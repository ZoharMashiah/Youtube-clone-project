...
public class User {
    ...
    public User(String username, String password, String firstName, String middleName, String lastName, String birthDate, String profilePicture, boolean darkMode) {
